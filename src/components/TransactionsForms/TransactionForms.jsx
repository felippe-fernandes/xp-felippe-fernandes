...
function TransactionForms() {
  ...
  const [activeWithdrawalButton, setActiveWithdrawalButton] =
    useState('normal');
    ...
    <div className={styles.TransactionFormsComponent}>
      <div className={styles.Forms}>
        <div className={styles.Buttons}>
          ...
          >
            ...
            <div>
              <FontAwesomeIcon
                icon={faMoneyBill1}
                className={styles.MoneyBillIcon}
              />
        ...
        <InputGroup className={styles.Input}>
          <Form.Control
            onChange={({ target }) =>
              setInputValue(Number(target.value.replace('.', '.')))
            }
  ...
  const confirmedTransaction = (
    <div className={styles.SuccessScreenComponent}>
      <div className={styles.SuccessScreen}>
        ...
        <button id={styles.OkButton} onClick={handleOkClick}>
          OK
        </button>
      </div>
    </div>
  ...
  return <>{confirmationScreen ? confirmedTransaction : transactionScreen}</>;
}
